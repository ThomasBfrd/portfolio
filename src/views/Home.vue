...
<template>
  <div class="text-foreground">
    <section class="p-4">
      <h1 class="text-4xl font-bold hidden md:block">{{ PROFILE.name }}</h1>
      <p class="text-md italic hidden md:block">{{ PROFILE.email }}</p>
      <p class="md:mt-4 max-w-3xl leading-relaxed">
